...
SELECT 
	CONCAT(m.firstname, ' ', m.surname, ' - ', f.name) AS member_court_info
...
INNER JOIN 
    Members AS m ON booking_costs.memid = m.memid
INNER JOIN 
    Facilities AS f ON booking_costs.facid = f.facid
WHERE 
    booking_costs.starttime >= '2012-09-14 00:00:00'
    AND booking_costs.starttime < '2012-09-15 00:00:00'
    AND booking_costs.total_cost > 30
ORDER BY 
    booking_costs.total_cost DESC;
